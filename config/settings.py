...
# Database
# Detecta automáticamente la base de datos de Railway
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'API Inventario Papeleria',
    'DESCRIPTION': 'Documentación interactiva de las APIs del Punto de Venta e Inventario',
    'VERSION': '1.0.0',
